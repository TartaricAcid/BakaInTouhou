...
public class EntityYukariModel extends EntityTouhouCharacterModel {
    //fields
    ...
    public EntityYukariModel() {
        ...
        chest = new ModelRenderer(this, 42, 12);
        chest.addBox(-2.5F, -2.5F, -2.5F, 5, 3, 2);
        chest.setRotationPoint(0F, 11F, -1F);
        chest.setTextureSize(128, 32);
        chest.mirror = true;
        setRotation(chest, 0.6108652F, 0F, 0F);
        ...
        headdress = new ModelRenderer(this, 70, 13);
        headdress.addBox(-4.5F, -3F, 0F, 9, 5, 0);
        headdress.setRotationPoint(0F, -1F, -3.9F);
        headdress.setTextureSize(128, 32);
        headdress.mirror = true;
        setRotation(headdress, -0.1745329F, 0F, 0F);
        hair = new ModelRenderer(this, 70, 19);
        hair.addBox(-4F, 0F, 0F, 8, 10, 0);
        hair.setRotationPoint(0F, 8F, 4F);
        hair.setTextureSize(128, 32);
        hair.mirror = true;
        setRotation(hair, 0.2617994F, 0F, 0F);
        hairR = new ModelRenderer(this, 0, 0);
        hairR.addBox(0F, 0F, 0F, 0, 6, 1);
        hairR.setRotationPoint(-4F, 8F, -3.5F);
        hairR.setTextureSize(128, 32);
        hairR.mirror = true;
        setRotation(hairR, 0F, 0F, 0.3490659F);
        hairL = new ModelRenderer(this, 0, 0);
        hairL.addBox(0F, 0F, 0F, 0, 6, 1);
